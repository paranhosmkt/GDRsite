...
const localDefaultMaterials: SanityMaterial[] = [
  {
    ...
    description: "Por que a informalidade histórica no mercado imobiliário não tem mais espaço e como a Lei nº 13.097/2015 oferece o modelo contratual ideal para imobiliárias e corretores.",
    badge: "Ler Artigo",
    date: "2026",
  ...
  },
  {
    ...
    description: "Compreenda quando o não recolhimento de tributos ultrapassa a esfera administrativa e ingressa na seara penal, além das estratégias legais de defesa.",
    badge: "Ler Artigo",
    date: "2026",
  ...
  },
  {
    ...
    description: "Duas décadas após a promulgação da Lei nº 11.340/2006, analisamos o ecossistema protetivo, a multifacetada violência de gênero e os rumos da responsabilização penal.",
    badge: "Ler Artigo",
    date: "2026",
  ...
  },
  {
    ...
    description: "Entenda por que a parametrização de ERPs, a gestão da não cumulatividade plena e o impacto no fluxo de caixa exigem ação imediata antes de 2027.",
    badge: "Ler Artigo",
    date: "2026",
  ...
  },
  {
    ...
    description: "Análise técnica sobre planejamento sucessório, eficiência tributária na locação de imóveis e os cuidados documentais prévios à constituição da sociedade.",
    badge: "Ler Artigo",
    date: "2026",
  ...
  },
  {
    ...
    description: "Como a fiscalização trabalhista, o passivo de indenizações e a gestão de pessoas foram transformados pela exigência de mapeamento contínuo dos ambientes corporativos.",
    badge: "Ler Artigo",
    date: "2026",
  ...
  },
  {
    ...
    description: "A importância de adequar a base de cálculo da Lei nº 8.213/1991 à realidade dos setores críticos de saúde por meio de perícia técnica individualizada.",
    badge: "Ler Artigo",
    date: "2026",
